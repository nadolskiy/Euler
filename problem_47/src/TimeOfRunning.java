...
public class TimeOfRunning
{
    ...
    public static void run(Date startDate, Date endDate)
    {
        ...
        if (Integer.parseInt(eTime[0]) != Integer.parseInt(sTime[0]))
        {
            if (Integer.parseInt(eTime[0]) > Integer.parseInt(sTime[0]))
            {
                h = Integer.parseInt(eTime[0]) - Integer.parseInt(sTime[0]);
            }
            else if (Integer.parseInt(eTime[0]) < Integer.parseInt(sTime[0]))
            {
                m = (60 - Integer.parseInt(sTime[0])) + Integer.parseInt(eTime[0]);
            }
            else if (Integer.parseInt(eTime[0]) > Integer.parseInt(sTime[0]))
            {
                m = Integer.parseInt(eTime[0]) - Integer.parseInt(sTime[0]);
            }

            if (Integer.parseInt(eTime[2]) < Integer.parseInt(sTime[2]))
            {
                s = (60 - Integer.parseInt(sTime[2])) +Integer.parseInt(eTime[2]);
            }
            else if (Integer.parseInt(eTime[2]) > Integer.parseInt(sTime[2]))
            {
                s = Integer.parseInt(eTime[2]) - Integer.parseInt(sTime[2]);
            }
        }
        if (Integer.parseInt(eTime[1]) != Integer.parseInt(sTime[1]))
        {
            if (Integer.parseInt(eTime[1]) < Integer.parseInt(sTime[1]))
            {
                m = (60 - Integer.parseInt(sTime[0])) + Integer.parseInt(eTime[0]);
            ...
            else if (Integer.parseInt(eTime[1]) < Integer.parseInt(sTime[1]))
            {
                m = Integer.parseInt(eTime[1]) - Integer.parseInt(sTime[1]);
            }
        }
        if (Integer.parseInt(eTime[2]) != Integer.parseInt(sTime[2]))
        {
